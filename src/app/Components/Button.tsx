...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const merged = cn(
    'group flex items-center hover:transition-all disabled:cursor-not-allowed relative justify-center duration-300 disabled:pointer-events-none py-4 px-[38px] max-h-12 font-bold',
    {
  ...
  return (
    <div>
      <button ref={ref} type={type} className={merged} disabled={disabled} {...rest}>
        {children}
      </button>
